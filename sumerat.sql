...
('860', 'Penilaian'),
('861', 'Penghargaan'),
('861.1', 'Penghargaan Bintang/Satyalancana'),
('861.2', 'Penghargaan Kenaikan Pangkat Anu'),
('861.3', 'Penghargaan Kenaikan Gaji Istimewa'),
('861.4', 'Penghargaan Hadiah Berupa Uang'),
('861.5', 'Penghargaan Pegawai Teladan'),
('862', 'Hukuman'),
('862.1', 'Hukuman Tegoran/peringatan'),
('862.2', 'Hukuman Penundaan Kenaikan Gaji'),
('862.3', 'Hukuman Penurunan Pangkat'),
('862.4', 'Hukuman Pemindahan'),
('863', 'Konduite'),
('864', 'Ujian Dinas'),
('864.1', 'Ujian Dinas Tingkat I'),
('864.2', 'Ujian Dinas Tingkat II'),
('864.3', 'Ujian Dinas Tingkat III'),
...
('872', 'Bezetting'),
('873', 'Registrasi'),
('873.1', 'Registrasi NIP'),
('873.2', 'Registrasi KARPEG'),
('873.3', 'Registrasi Legitimasi/Tanda Pengenal'),
('874', 'Daftar Riwayat Pekerjaan'),
('874.1', 'Daftar Riwayat Pekerjaan Tanggal Lahir'),
('874.2', 'Daftar Riwayat Pekerjaan Penggantia Nama'),
('874.3', 'Daftar Riwayat Pekerjaan Kepartaian/Organisasi'),
('875', 'Kewenangan Mutasi Kepegawaian'),
('875.1', 'Pelimpahan Wewenang'),
('875.2', 'Specimen Tanda Tangan'),
('876', 'Penggajian'),
('876.1', 'Penggajian SKKP'),
('877', 'Sumpah/Janji'),
('878', 'Korps Kepegawaian'),
('880', 'Pemberhentian'),
('881', 'Pemberhentian Permintaan Sendiri'),
('882', 'Pemberhentiaan Dengan Hak Pensiun'),
('882.1', 'Pemberhentian Dengan HaK Pensiun Pegawai Negeri Golongan I'),
('882.2', 'Pemberhentian Dengan HaK Pensiun Pegawai Negeri Golongan II'),
('882.3', 'Pemberhentian Dengan HaK Pensiun Pegawai Negeri Golongan III'),
('882.4', 'Pemberhentian Dengan HaK Pensiun Pegawai Negeri Golongan IV'),
('882.5', 'Pemberhentian Pensiun Janda/Duda'),
('882.6', 'Pemberhentian Pensiun Yatiam Piatu'),
('882.7', 'Pemberhentian Uang Muka Pensiun'),
('883', 'Pemberhentian Karena Meninggal'),
('883.1', 'Pemberhentian Karena Meninggal Dalam Tugas'),
('884', 'Pemberhentian Alasan Lain'),
('885', 'Pemberhentian Uang Pesangon'),
('886', 'Pemberhentian Uang Tunggu'),
('887', 'Pemberhentian Untuk Sementara Waktu'),
('888', 'Pemberhentian Tidak Dengan Hormat'),
('890', 'Pendidikan Pegawai'),
('891', 'Perencanaan Pendidikan Pegawai'),
('892', 'Pendidikan Reguler'),
('892.1', 'Pendidikan Reguler IIP'),
('892.2', 'Pendidikan Reguler Akademi'),
('892.21', 'Pendidikan Reguler Agaria'),
('892.22', 'Pendidikan Reguler Pemerintah Dalam Negeri'),
('892.3', 'Pendidikan Reguler Kursus-kursus Reguler'),
('893', 'Pendidikan Non Reguler'),
('893.1', 'Pendidikan Non Reguler SESPA'),
('893.2', 'Pendidikan Non Reguler SELAPUTDA'),
('893.3', 'Pendidikan Non Reguler Kursus-kursus/Penataran'),
('894', 'Pendidikan Luar Negeri'),
('895', 'Metode Pendidikan Pegawai'),
('895.1', 'Metode Pendidikan Pegawai Kuliah'),
('895.2', 'Metode Pendidikan Pegawai Ceramah, Simposium'),
('895.3', 'Metode Pendidikan Pegawai Diskusi'),
('895.4', 'Metode Pendidikan Pegawai Kuliah Lapangan, Widya Wisata, KKN'),
('895.5', 'Metode Pendidikan Pegawai Kurikulum'),
('895.6', 'Metode Pendidikan Pegawai Karya Tulis'),
('896', 'Tenaga Pengajar'),
('897', 'Administrasi Pendidikan'),
('897.1', 'Administrasi Pendidikan Tahun Pelajaran'),
('897.2', 'Administrasi Pendidikan Persyaratan, meliputi Pendaftaran, Testing, Ujian'),
('898', 'Fasilitas Pendidikan Pegawai'),
('898.1', 'Fasilitas Tunjangan Belajar'),
('898.2', 'Fasilitas Asrama'),
('898.3', 'Fasilitas Uang Makan'),
('898.4', 'Fasilitas Uang Transport'),
('898.5', 'Fasilitas Uang Buku'),
('899', 'Sarana Pendidikan Pegawai'),
('899.1', 'Sarana Buku'),
('899.2', 'Sarana Gedung'),
('900', 'Keuangan'),
('901', 'Nota Keuangan'),
...
('920', 'Otoritas'),
('921', 'Otoritas Rutin'),
('922', 'Otoritas Pembangunan'),
('923', 'Otoritas SIAP'),
('924', 'Otoritas Ralat SKO'),
('930', 'Verifikasi'),
('931', 'SPM Rutin'),
('932', 'SPM Pembangunan'),
('933', 'Penerimaan Verifikasi'),
('934', 'SPJ Rutin'),
('935', 'SPJ Pembangunan'),
