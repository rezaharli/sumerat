	...
	<div class="col-lg-6">
		<table  class="table-form">
			...
			<tr><td width="20%">Asal Surat</td><td><b>
				<input type="text" name="asal" required value="<?php if(isset($results)) echo $results->asal; ?>" id="pengirim" style="width: 400px" class="form-control">
			</b></td></tr>
			<tr><td width="20%">Tanggal Surat</td><td><b>
				<input type="text" name="tanggal_surat" required value="<?php if(isset($results)) echo $results->tanggal_surat; ?>" id="tanggal_surat" style="width: 400px" class="form-control">
			</b></td></tr>	
		</table>
	</div>
	...
	<div class="col-lg-6">	
		<table  class="table-form">		
			...
			<tr><td width="20%" valign="top">Diajukan Kepada</td><td>
				<?php
				echo form_checkbox(array('name' => 'diajukan_kepada[]', 'value' => 'Sekretaris')).'Sekretaris'.'<br />';
				echo form_checkbox(array('name' => 'diajukan_kepada[]', 'value' => 'Kepala Bidang LL')).'Kepala Bidang LL'.'<br />';
				echo form_checkbox(array('name' => 'diajukan_kepada[]', 'value' => 'Kepala Bidang SARPRA')).'Kepala Bidang SARPRA'.'<br />';
				echo form_checkbox(array('name' => 'diajukan_kepada[]', 'value' => 'Kepala Bidang KOMINFO')).'Kepala Bidang KOMINFO'.'<br />';
				echo form_checkbox(array('name' => 'diajukan_kepada[]', 'value' => 'Ka. UPTD PKB')).'Ka. UPTD PKB';
				$input_diajukan_kepada = array(
				...
				echo form_input($input_diajukan_kepada);
				?>
